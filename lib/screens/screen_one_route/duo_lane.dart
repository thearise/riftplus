...
class DuoLane extends StatefulWidget {
  const DuoLane({Key key, this.desc}) : super(key: key);
  final String desc;

  @override
  _DuoLaneState createState() => _DuoLaneState();
}

class _DuoLaneState extends State<DuoLane>  with TickerProviderStateMixin{
...
//                   ),
                      child: ListView(
                        children: [
                          Image(image: AssetImage('assets/images/system/duo-pos-screen.png')),
                          TitleView(
                          ...
                          RichText(
                            text: TextSpan(
                              children: [
                                ...
                                // WidgetSpan(
                                //   child: Image(image: AssetImage('assets/images/system/duo-pos-screen.png'), width: 10,),
                                // )
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'duo position'),),
                      );
                    },
                  ),
                ),
