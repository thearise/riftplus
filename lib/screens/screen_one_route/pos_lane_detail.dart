...
class PosLaneDet extends StatefulWidget {
  const PosLaneDet({Key key, this.type}) : super(key: key);
  final String type;

  @override
  _PosLaneDetState createState() => _PosLaneDetState();
}

class _PosLaneDetState extends State<PosLaneDet>  with TickerProviderStateMixin{
...
// Here you can write your code
                                ...
                                child: ListView(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        snapshot.data[1]=='_en'?posLaneTextEN(snapshot.data[0]):posLaneTextMM(snapshot.data[0]),
            ...
            Expanded(
              child: Center(
                child: Padding(
                  ...
                  child: Text(
                    widget.type.toUpperCase() + ' POSITION',
                    textScaleFactor: 1,
                    style: TextStyle(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: widget.type + ' position'),),
                      );
                    },
                  ),
                ),
  ...
  posLaneTextMM(data) {
    ...
    } else if(widget.type=='solo') {
      return data.baron.toString();
    } else if(widget.type=='jungle') {
      return data.jungle.toString();
    } else if(widget.type=='duo') {
      return data.duo.toString();
    } else if(widget.type=='support') {
      return data.dragon.toString();
    }
    return Container();
  }
  ...
  posLaneTextEN(data) {
    if(widget.type=='mid') {
      return data.mid_en.toString();
    } else if(widget.type=='solo') {
      return data.baron_en.toString();
    } else if(widget.type=='jungle') {
      return data.jungle_en.toString();
    } else if(widget.type=='duo') {
      return data.duo_en.toString();
    } else if(widget.type=='support') {
      return data.dragon_en.toString();
    }
    return Container();
  }
