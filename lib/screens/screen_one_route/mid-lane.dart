...
class MidLane extends StatefulWidget {
  const MidLane({Key key, this.desc}) : super(key: key);
  final String desc;

  @override
  _MidLaneState createState() => _MidLaneState();
}

class _MidLaneState extends State<MidLane>  with TickerProviderStateMixin{
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        children: [
                          Image(image: AssetImage('assets/images/system/mid-pos-screen.png')),
                          TitleView(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'mid position'),),
                      );
                    },
                  ),
                ),
