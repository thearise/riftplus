...
class DragonLane extends StatefulWidget {
  const DragonLane({Key key, this.desc}) : super(key: key);
  final String desc;

  @override
  _DragonLaneState createState() => _DragonLaneState();
}

class _DragonLaneState extends State<DragonLane>  with TickerProviderStateMixin{
...
//                   ),
                      child: ListView(
                        children: [
                          Image(image: AssetImage('assets/images/system/support-post-screen.png')),
                          TitleView(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'support position'),),
                      );
                    },
                  ),
                ),
