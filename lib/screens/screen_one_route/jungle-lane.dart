...
class JungleLane extends StatefulWidget {
  const JungleLane({Key key, this.desc}) : super(key: key);
  final String desc;

 @override
 _JungleLaneState createState() => _JungleLaneState();
}

class _JungleLaneState extends State<JungleLane>  with TickerProviderStateMixin{
               ...
               children: [
                 Padding(
                   ...
                   child: Container(
                     ...
                     child: ListView(
                       children: [
                         Image(image: AssetImage('assets/images/system/jungle-pos-screen.png')),
                         TitleView(
                 ...
                 child: InkWell(
                   ...
                   onTap: () {
                     ...
                     Navigator.of(context, rootNavigator:true).push(
                       FadeRoute(page: ReportDetailPage(name: 'jungle position'),),
                     );
                   },
                 ),
               ),
