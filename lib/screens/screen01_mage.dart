...
class ScreenOneMage extends StatefulWidget {
  const ScreenOneMage({Key key}) : super(key: key);

  @override
  _ScreenOneMageState createState() => _ScreenOneMageState();
}

class _ScreenOneMageState extends State<ScreenOneMage>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ScreenOneMage>{
  @override
  ...
  Future<List<Season>> fetchSeasons() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllMages.php');
