...
class ScreenOneMaskman extends StatefulWidget {
  const ScreenOneMaskman({Key key}) : super(key: key);

  @override
  _ScreenOneMaskmanState createState() => _ScreenOneMaskmanState();
}

class _ScreenOneMaskmanState extends State<ScreenOneMaskman>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ScreenOneMaskman>{
  @override
  ...
  Future<List<Season>> fetchSeasons() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllMarksmans.php');
