...
class ItemsMagicalAPI extends StatefulWidget {
  const ItemsMagicalAPI({Key key}) : super(key: key);

  @override
  _ItemsMagicalAPIState createState() => _ItemsMagicalAPIState();
}


class _ItemsMagicalAPIState extends State<ItemsMagicalAPI>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ItemsMagicalAPI>{
  @override
  ...
  Future<List<Item>> fetchItemsBased() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllMagiclItems.php');
    //print(response.body);
    if (response.statusCode == 200) {
      itemResponse = response.toString();
      Map<String, dynamic> jsonObject = json.decode(response.toString());
      Iterable list = jsonObject["basic"];
  ...
  Future<List<Item>> fetchItemsMidtier() async {
    final response =
    await http.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllMagiclItems.php');
    //print(response.body);
    if (response.statusCode == 200) {
      Map<String, dynamic> jsonObject = json.decode(response.body);
      Iterable list = jsonObject["mid-tire"];
      var items = list.map((itemMidtier) => Item.fromJson(itemMidtier)).toList();
      setState(() {
  ...
  Future<List<Item>> fetchItemsUpgraded() async {
    ...
    if (response.statusCode == 200) {
      Map<String, dynamic> jsonObject = json.decode(response.body);
      Iterable list = jsonObject["upgraded"];
      var items = list.map((itemUpgraded) => Item.fromJson(itemUpgraded)).toList();
      setState(() {
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (context) => SeeAllRoute(item: itemResponse, id: 'basic', name:'BASIC ITEMS'))
                                      );
                                    },
                                    child: Padding(
                                ...
                                children: <Widget>[
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (context) => SeeAllRoute(item: itemResponse, id: 'mid-tire', name:'MID TIER ITEMS'))
                                      );
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.only(left: 8),
                                ...
                                children: <Widget>[
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (context) => SeeAllRoute(item: itemResponse, id: 'upgraded', name:'UPGRADED ITEMS'))
                                      );
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.only(left: 8),
