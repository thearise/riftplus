...
class ItemsDefenceAPI extends StatefulWidget {
  const ItemsDefenceAPI({Key key}) : super(key: key);

  @override
  _ItemsDefenceAPIState createState() => _ItemsDefenceAPIState();
}


class _ItemsDefenceAPIState extends State<ItemsDefenceAPI>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ItemsDefenceAPI>{
  @override
  ...
  Future<List<Item>> fetchItemsBased() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllDefenselItems.php');
    //print(response.body);
  ...
  Future<List<Item>> fetchItemsMidtier() async {
    final response =
    await http.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllDefenselItems.php');
    //print(response.body);
    if (response.statusCode == 200) {
