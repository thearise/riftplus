...
class ScreenOneAssasin extends StatefulWidget {
  const ScreenOneAssasin({Key key}) : super(key: key);

  @override
  _ScreenOneAssasinState createState() => _ScreenOneAssasinState();
}

class _ScreenOneAssasinState extends State<ScreenOneAssasin>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ScreenOneAssasin>{
  @override
  ...
  Future<List<Season>> fetchSeasons() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllAssassins.php');
