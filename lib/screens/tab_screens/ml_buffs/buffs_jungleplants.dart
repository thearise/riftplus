...
class Infos {
  final String scryer;
  final String scryer_en;

  final String blast;
  final String blast_en;

  final String honey;
  final String honey_en;
  ...
  factory Infos.fromJson(Map<String, dynamic> json){
    return Infos(
        scryer: json['scryer'],
        scryer_en: json['scryer_en'],
        blast: json['blast'],
        blast_en: json['blast_en'],
        honey: json['honey'],
        honey_en: json['honey_en'],
    );
  }
}
...
class BuffsJunglePlants extends StatefulWidget {

  @override
  _BuffsJunglePlantsState createState() => _BuffsJunglePlantsState();
}

class _BuffsJunglePlantsState extends State<BuffsJunglePlants>  with TickerProviderStateMixin{
  ...
  Future<Infos> fetchDetInfos() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getDetJunglePlanInfos.php');
                          ...
                          return Stack(
                            ...
                            children: [
                              Container(
                                ...
                                child: ListView(
                                  children: [
                                    Image(image: AssetImage('assets/images/system/jungle-plants.png')),
                                    TitleView(
                                      titleTxt: 'Scryer\'s Bloom',
                                      subTxt: '',
                                      id: '',
                                    ),
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image(image: AssetImage('assets/images/system/scryers-bloom.png'))
                                      ),
                                    ),
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            ...
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].scryer_en.toString():snapshot.data[0].scryer.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                          child: Image(image: AssetImage('assets/images/system/blast-cone.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].blast_en.toString():snapshot.data[0].blast.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                          child: Image(image: AssetImage('assets/images/system/honey-fruit.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].honey_en.toString():snapshot.data[0].honey.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'Plants'),),
                      );
                    },
                  ),
                ),
