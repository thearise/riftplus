...
class BuffsBlueNRed extends StatefulWidget {

  @override
  _BuffsBlueNRedState createState() => _BuffsBlueNRedState();
}

class _BuffsBlueNRedState extends State<BuffsBlueNRed>  with TickerProviderStateMixin{
  ...
  Future<Infos> fetchDetInfos() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getDetBlueNRedInfos.php');
                          ...
                          return Stack(
                            ...
                            children: [
                              Container(
                                ...
                                child: ListView(
                                  children: [
                                    Image(image: AssetImage('assets/images/system/blue-n-red.png')),
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image(image: AssetImage('assets/images/system/bluebuffs.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].blue_en.toString():snapshot.data[0].blue.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                          child: Image(image: AssetImage('assets/images/system/redbuffs.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].red_en.toString():snapshot.data[0].red.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'Blue & Red Buffs'),),
                      );
                    },
                  ),
                ),
