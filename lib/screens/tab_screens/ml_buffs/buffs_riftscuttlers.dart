...
class BuffsRiftScuttlers extends StatefulWidget {

  @override
  _BuffsRiftScuttlersState createState() => _BuffsRiftScuttlersState();
}

class _BuffsRiftScuttlersState extends State<BuffsRiftScuttlers>  with TickerProviderStateMixin{
  ...
  Future<Infos> fetchDetInfos() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getDetRiftScutInfos.php');
                          ...
                          return Stack(
                            ...
                            children: [
                              Container(
                                ...
                                child: ListView(
                                  children: [
                                    Image(image: AssetImage('assets/images/system/crab-n-speed.png')),
                                    Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'Rift Scuttlers'),),
                      );
                    },
                  ),
                ),
