...
class Infos {
  ...
  final String raptors;
  final String raptors_en;

  final String wolves;
  final String wolves_en;

  final String gromp;
  final String gromp_en;

  final String krugs;
  final String krugs_en;
  ...
  factory Infos.fromJson(Map<String, dynamic> json){
    return Infos(
        ...
        raptors: json['raptors'],
        raptors_en: json['raptors_en'],
        wolves: json['wolves'],
        wolves_en: json['wolves_en'],
        gromp: json['gromp'],
        gromp_en: json['gromp_en'],
        krugs: json['krugs'],
        krugs_en: json['krugs_en']
    );
  }
}
...
class BuffsJungleMonsters extends StatefulWidget {

  @override
  _BuffsJungleMonstersState createState() => _BuffsJungleMonstersState();
}

class _BuffsJungleMonstersState extends State<BuffsJungleMonsters>  with TickerProviderStateMixin{
  ...
  Future<Infos> fetchDetInfos() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getDetJungleMonInfos.php');
                          ...
                          return Stack(
                            ...
                            children: [
                              Container(
                                ...
                                child: ListView(
                                  children: [
                                    Image(image: AssetImage('assets/images/system/monsters.png')),
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image(image: AssetImage('assets/images/system/raptors.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].raptors_en.toString():snapshot.data[0].raptors.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                          child: Image(image: AssetImage('assets/images/system/murk-wolves.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].wolves_en.toString():snapshot.data[0].wolves.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                          child: Image(image: AssetImage('assets/images/system/gromp.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].gromp_en.toString():snapshot.data[0].gromp.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                          child: Image(image: AssetImage('assets/images/system/krugs.png'))
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                            child: ReadMoreText(
                                              snapshot.data[1]=='_en'?snapshot.data[0].krugs_en.toString():snapshot.data[0].krugs.toString()
                                              ,
                                              trimLines: 2,
                                              textScaleFactor: 1,
                                              style: const TextStyle(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'Monsters'),),
                      );
                    },
                  ),
                ),
