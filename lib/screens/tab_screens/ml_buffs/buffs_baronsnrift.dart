...
class BuffsBaronsNRift extends StatefulWidget {

  @override
  _BuffsBaronsNRiftState createState() => _BuffsBaronsNRiftState();
}

class _BuffsBaronsNRiftState extends State<BuffsBaronsNRift>  with TickerProviderStateMixin{
  ...
  Future<Infos> fetchDetInfos() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getDetBaronNRiftInfos.php');
                          ...
                          return Stack(
                            ...
                            children: [
                              Container(
                                  ...
                                  child: ListView(
                                    children: [
                                      Image(image: AssetImage('assets/images/system/baron-n-rift.png')),
                                      TitleView(
                                        titleTxt: 'Rift Herald',
                                        subTxt: '',
                                        id: '',
                                      ),
                                      Padding(
                                        ...
                                        child: ClipRRect(
                                            ...
                                            child: Image(image: AssetImage('assets/images/system/rift-herald.png'))
                                        ),
                                      ),
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: ReadMoreText(
                                                snapshot.data[1]=='_en'?snapshot.data[0].rift_en.toString():snapshot.data[0].rift.toString()
                                                ,
                                                trimLines: 2,
                                                textScaleFactor: 1,
                                      ...
                                      Padding(
                                        ...
                                        child: ClipRRect(
                                            borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                            child: Image(image: AssetImage('assets/images/system/baron-nashor.png'))
                                        ),
                                      ),
                                      SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              padding: const EdgeInsets.only(left: 20.0, top: 15.0, right: 20.0, bottom: 20.0),
                                              child: ReadMoreText(
                                                snapshot.data[1]=='_en'?snapshot.data[0].baron_en.toString():snapshot.data[0].baron.toString(),
                                                trimLines: 2,
                                                textScaleFactor: 1,
                                                style: const TextStyle(
                                                    fontSize: 15,
                                      ...
                                      //       if(snapshot.hasData && snapshot.data.type.contains('nativeAndroid') && Platform.isAndroid) {
                                      //         return Container(
                                      //             decoration: BoxDecoration(
                                      //                 color: Colors.black26,
                                      //                 border: Border(top: BorderSide(color: AppTheme.lineColor, width: 1.0))
                                      //             ),
                                      //             child: Column(
                                      //                 children: [
                                      //                   Padding(
                                      ...
                                      //                   ),
                                      //                   Padding(
                                      //                     padding: const EdgeInsets.only(top: 15.0, left: 20.0, right: 20.0, bottom: 20.0),
                                      //                     child: Padding(
                                      //                       padding: const EdgeInsets.only(bottom: 20.0),
                                      //                       child: FacebookNativeAd(
                                      //                         placementId: Platform.isAndroid? "708437736767412_710323316578854":'IMG_16_9_APP_INSTALL#258023022488835_261601588797645',
                                      //                         adType: Platform.isAndroid? NativeAdType.NATIVE_AD: NativeAdType.NATIVE_AD_VERTICAL,
                                      //
                                      //                         backgroundColor: AppTheme.priBgColor,
                                      //                         titleColor: AppTheme.labTextActive,
                                      //                         descriptionColor: AppTheme.labTextActive,
                                      //                         buttonColor: AppTheme.activeIcon,
                                      //                         buttonTitleColor: AppTheme.labTextActive,
                                      //                         buttonBorderColor: AppTheme.labTextActive,
                                      //                         listener: (result, value) {
                                      ...
                                      //             )
                                      //         );
                                      //       } else if (snapshot.hasData && snapshot.data.type.contains('nativeIOS') && !Platform.isAndroid) {
                                      //         return Container(
                                      //             decoration: BoxDecoration(
                                      //                 color: Colors.black26,
                                      //                 border: Border(top: BorderSide(color: AppTheme.lineColor, width: 1.0))
                                      ...
                                      //                   ),
                                      //                   Padding(
                                      //                     padding: const EdgeInsets.only(top: 15.0, left: 0.0, right: 0.0, bottom: 20.0),
                                      //                     child: Padding(
                                      //                       padding: const EdgeInsets.only(bottom: 20.0),
                                      //                       child: AdmobBanner(
            ...
            Expanded(
              child: Center(
                child: Padding(
                  ...
                  child: Text(
                    'Baron Nashor and Rift Herald'.toUpperCase(),
                    textScaleFactor: 1,
                    style: TextStyle(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context, rootNavigator:true).push(
                        FadeRoute(page: ReportDetailPage(name: 'Baron & Rift Herald'),),
                      );
                    },
                  ),
                ),
