...
import 'package:riftplus02/screens/rnsRunesApi.dart';
import 'package:riftplus02/screens/tab_screens/rnsSpells.dart';
...
class RunesNSpells extends StatefulWidget {
  const RunesNSpells({Key key, this.id, this.image, this.name, this.desc, this.price, this.type}) : super(key: key);
  final String id;
  final String image;
  final String name;
  final String desc;
  ...
  @override
  _RunesNSpellsState createState() => _RunesNSpellsState();
}

class _RunesNSpellsState extends State<RunesNSpells>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<RunesNSpells>{
  @override
