...
class ScreenOneTank extends StatefulWidget {
  const ScreenOneTank({Key key}) : super(key: key);

  @override
  _ScreenOneTankState createState() => _ScreenOneTankState();
}

class _ScreenOneTankState extends State<ScreenOneTank>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ScreenOneTank>{
  @override
  ...
  Future<List<Season>> fetchSeasons() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllTanks.php');
