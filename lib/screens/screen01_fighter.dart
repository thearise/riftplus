...
class ScreenOneFighter extends StatefulWidget {
  const ScreenOneFighter({Key key, this.data}) : super(key: key);
  final String data;

  @override
  _ScreenOneFighterState createState() => _ScreenOneFighterState();
}

class _ScreenOneFighterState extends State<ScreenOneFighter>  with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<ScreenOneFighter>{
  @override
  ...
  Future<List<Season>> fetchSeasons() async {
    final response =
    await dio.get('https://hninsunyein.me/rift_plus/rift_plus/api/getAllFighters.php');
